					...
					<div class="detail--box-image">
						<a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88228/88228_1000.jpg" title="포스터 크게 보기 새창" target="_blank">
							<span class="detail--thumb-image">
								<img class="detail--movie-poster" src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88228/88228_320.jpg" alt="데드풀과 울버린 포스터">
					...
					<div class="detail--box-contents">
						...
						<div class="detail--box-info">
							<ul class="detail--box-info-ui">
								<li class="detail--box-info-ui-li">감독 : 숀레비</li>
								<li class="detail--box-info-ui-li">배우 : 라이언 레이놀즈, 휴 잭맨, 엠마 코린, 모레나 바카린, 롭 딜레이니, 레슬리 우감스, 카란 소니, 매튜 맥퍼딘</li>
								<li class="detail--box-info-ui-li">장르 : 액션, 코미디, SF</li>
								<li class="detail--box-info-ui-li">기본 정보 : 청소년관람불가, 127분, 미국</li>
								<li class="detail--box-info-ui-li">개봉일 : 2024.07.24</li>
							</ul>
						</div>
